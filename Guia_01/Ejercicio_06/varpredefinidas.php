...
<head>
  ...
  <title>Variables predefinidas en PHP</title>
...
<body>
  ...
  printf("<ul>\n<li>El nombre del servidor donde se está ejecutando este script es: <b><i>\$_SERVER['SERVER_NAME'] = %s</i></b></li>\n", $_SERVER['SERVER_NAME']);
  ...
  printf("<li>El puerto de la máquina usado por el servidor web para la comunicación HTTP es: <b><i>\$_SERVER['SERVER_PORT'] = %s</i></b></li>\n", $_SERVER['SERVER_PORT']);
  ...
  printf("<li>El puerto empleado por el equipo del usuario para comunicarse con el servidor es: <b><i>\$_SERVER['REMOTE_PORT'] = %s</i></b></li>\n", $_SERVER['REMOTE_PORT']);
  printf("<li>El  idioma  definido  por el navegador de tu computadora es: <b><i>\$_SERVER['HTTP_ACCEPT_LANGUAGE'] = %s</i></b></li>\n", $_SERVER['HTTP_ACCEPT_LANGUAGE']);
  printf("<li>Estás viendo esta página en un navegador: <b><i>\$_SERVER['HTTP_USER_AGENT'] = %s</i></b></li>\n", $_SERVER['HTTP_USER_AGENT']);
  printf("<li>El puerto de comunicación con el servidor de la computadora que estás utilizando es: <b><i>\$_SERVER['REMOTE_PORT'] = %s</i></b></li>\n", $_SERVER['REMOTE_PORT']);
  printf("<li>La ubicación y el nombre del archivo que contiene el script que estás ejecutando es: <b><i>\$_SERVER['PHP_SELF'] = %s</i></b></li>\n</ul>", $_SERVER['PHP_SELF']);
  printf("</article>\n");
  printf("</section>\n");
  printf("</div>\n");
  ?>
